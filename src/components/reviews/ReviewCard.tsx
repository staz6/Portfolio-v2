...
export function ReviewCard({ review, index }: ReviewCardProps) {
  ...
  return (
    <div
      ...
      data-cursor-scale
      className="review-card-glow group relative flex w-80 shrink-0 snap-start flex-col gap-4 rounded-2xl border border-border/30 bg-card p-8 transition-[transform,border-color] duration-300 hover:-translate-y-1 hover:border-primary/50 lg:w-96"
    >
