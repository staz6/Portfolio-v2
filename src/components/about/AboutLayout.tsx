...
export function AboutLayout({ sectionRef, children, contentGap = "lg:gap-20", scene }: AboutLayoutProps) {
  return (
    ...
    >
      {/* Radial glow blobs */}
      <div className="pointer-events-none absolute -top-1/4 -left-1/4 h-[60%] w-[60%] rounded-full bg-primary/[0.06] blur-[60px] lg:blur-[120px]" />
      <div className="pointer-events-none absolute -right-1/4 -bottom-1/4 h-[50%] w-[50%] rounded-full bg-primary/[0.04] blur-[50px] lg:blur-[100px]" />
