...
/**
 * V3 — Original Noise Sphere (with wireframe core)
 * Same noise displacement as V1 but with a wireframe overlay on the inner core.
 */
...
export const AboutSphereV3 = memo(function AboutSphereV3({ color, entered = false }: Props) {
  ...
  const coreGeometry = useMemo(() => new THREE.IcosahedronGeometry(0.95, 16), []);
