...
/**
 * V7: Showcase — 3-col cards with scroll entrance + click opens animated overlay.
 * Cards fly in with rotation and stagger. Overlay has staggered content reveal.
 */

interface ProjectCardV7Props {
  project: ProjectData;
  index: number;
}

export function ProjectCardV7({ project, index }: ProjectCardV7Props) {
